...
var presetDefinitions = []presetDefinition{
	...
	{id: "vscode", name: "Visual Studio Code", paths: []string{"Library/Application Support/Code/User", ".vscode/extensions"}, keychainItems: []domain.BackupKeychainItem{{Service: "Code Safe Storage", Account: "Code Key"}}},
	...
	{id: "signal", name: "Signal", paths: []string{"Library/Application Support/Signal"}, keychainItems: []domain.BackupKeychainItem{{Service: "Signal Safe Storage", Account: "Signal Key"}}},
	...
	{id: "mongodb-compass", name: "MongoDB Compass", paths: []string{"Library/Application Support/MongoDB Compass"}, keychainItems: []domain.BackupKeychainItem{{Service: "MongoDB Compass Safe Storage", Account: "MongoDB Compass"}}},
	{id: "beekeeper-studio", name: "Beekeeper Studio", paths: []string{"Library/Application Support/beekeeper-studio"}, keychainItems: []domain.BackupKeychainItem{{Service: "Beekeeper Studio Safe Storage", Account: "Chrome"}}},
